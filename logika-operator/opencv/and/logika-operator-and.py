...
# Simpan hasil operasi and ke dalam sebuah file
cv2.imwrite('operator_and_' + namaImage1 + '_' + namaImage2, result)

# Tampilkan citra hasil and
cv2.imshow('Hasil Logika And', result)
cv2.waitKey(0)
