...
# Simpan hasil operasi or ke dalam sebuah file
cv2.imwrite('operator_or_' + namaImage1 + '_' + namaImage2, result)

# Tampilkan citra hasil or
cv2.imshow('Hasil Logika Or', result)
cv2.waitKey(0)
